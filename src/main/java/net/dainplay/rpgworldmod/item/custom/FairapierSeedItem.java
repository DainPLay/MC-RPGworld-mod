...
public class FairapierSeedItem extends ItemNameBlockItem {
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if (!interactionresult.consumesAction() && this.isEdible()) {
        ...
        } else if(!pContext.getLevel().getBlockState(pContext.getClickedPos()).is(Blocks.FARMLAND)){
            ...
            if (!pLevel.isClientSide) {
                ...
                pLevel.playSound((Player)null, thrownseed, SoundEvents.ENDER_PEARL_THROW, SoundSource.PLAYERS, 1.0F, 1.0F);
