...
public class RPGworldBiomeDecorator {
    ...
    public static Biome decorateRieWeald() {
       ...
       //BiomeDefaultFeatures.addWaterTrees(biomeFeatures);
        ...
        return biome(Biome.Precipitation.NONE, Biome.BiomeCategory.FOREST, 0.5F, 0.7F, ColorConstants.STANDARD_WATER, ColorConstants.STANDARD_WATERFOG, ColorConstants.RIE_WEALD_FOLIAGE_COLOR, ColorConstants.RIE_WEALD_GRASS_COLOR, spawnSettings, biomeFeatures);
    }
}
